...
st.markdown(
    ...
    <div class="banner-container">
        <img src="https://st2.depositphotos.com/1008648/7493/i/450/depositphotos_74933263-stock-photo-illustration-of-famous-monument-of.jpg" class="banner-img">
    </div>
    """,
...
with col1:
    source_city = st.text_input("🛫 Departure City", placeholder="E.g., Hyderabad")
    destination_city = st.text_input("📍Destination City", placeholder="E.g., California")
